...
let proverTestMakers: (KnowledgeBase -> Test) list = [
        fun testKb -> test "we can retrieve known expressions" { 
        ...
        fun testKb -> test "expressions are normalized, so the same variables can be reused in axioms" {
                let language = Language()
                let v = VarExprSource language
        ...
        fun testKb -> test "proofs can be repeated" {
            let language = Language()
            let v = VarExprSource language
        ...
        fun testKb -> test "known expressions can be proven without additional provers" {
            let language = Language()
        ...
        fun testKb -> test "the knowledge base can prove an open expression" {
            let language = Language()
        ...
        fun testKb -> test "the knowledge base can perform simple deduction" {
            let language = Language()
            let v = VarExprSource language
        ...
        fun testKb -> test "the knowledge base can perform a deduction chain" {
            let language = Language()
            let v = VarExprSource language
        ...
        fun testKb -> test "custom provers can receive arbitrary values" {
            let language = Language()
            let v = VarExprSource language
            let c = ConstExprSource language
        ...
        fun testKb -> test "custom prover failure is propagated to the caller" {
            let language = Language()
        ...
        fun testKb -> test "custom provers can be chained" {
            let language = Language()
            let v = VarExprSource language
            let c = ConstExprSource language
        ...
        fun testKb -> test "if a prover returns no response, no proof is found" {
            let language = Language()
            let v = VarExprSource language
            let c = ConstExprSource language
        ...
        fun testKb -> test "if a multiple custom provers can prove something, multiple proofs are found" {
            let language = Language()
            let v = VarExprSource language
            let c = ConstExprSource language
