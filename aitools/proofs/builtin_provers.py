...
from aitools.proofs.provers import OLD_Prover, Proof

logger = logging.getLogger(__name__)


class KnowledgeRetriever(OLD_Prover):
...
class DeclarativeProver(OLD_Prover):
...
class NegationProver(OLD_Prover):
    def __call__(self, formula: Expression, _kb=None, _truth: bool = True, _previous_substitution: Substitution = None):
...
class RestrictedModusPonens(OLD_Prover):
